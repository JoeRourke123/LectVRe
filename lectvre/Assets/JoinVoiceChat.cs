...
namespace Photon.Voice.Unity.UtilityScripts2
{
    [RequireComponent(typeof(VoiceConnection))]
    public class JoinVoiceChat : MonoBehaviour, IConnectionCallbacks, IMatchmakingCallbacks
    {
...
// public class JoinVoiceChat : MonoBehaviour
// {
